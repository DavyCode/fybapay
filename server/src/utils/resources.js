...
// AIRTIME
// private double agentCommission(String service){
//   double commission = 0;
//   if (service.equals("airtel")){
//       commission = 2;
//   }else if (service.equals("mtn")){
//       commission = 2;
//   }else if (service.equals("glo")){
//       commission = 2;
//   }else if (service.equals("etisalat")){
//       commission = 2;
...
// private double agentCommission(String service){
//   double commission = 0;
//   if (service.equals("airtel-data")){
//       commission = 2;
//   }else if (service.equals("mtn-data")){
//       commission = 2;
//   }else if (service.equals("glo-data")){
//       commission = 2;
//   }else if (service.equals("etisalat-data")){
//       commission = 2;
//   }else if (service.equals("smile-data")){
//       commission = 0.5;
//   }
//   return commission;
// }
...
// private double agentCommission(String service){
//   double commission = 0;
//   if (service.equals("aedc")){
//       commission = 0.5;
//   }else if (service.equals("ikeja_electricity")){
//       commission = 0.5;
//   }else if (service.equals("eko_electricity")){
//       commission = 0.5;
//   }else if (service.equals("phedc")){
//       commission = 0.5;
//   }else if (service.equals("eedc")){
//       commission = 0.5;
//   }else if (service.equals("ibedc")){
//       commission = 0.5;
//   }
//   return commission;
// }
...
// private double agentCommission(String service){
//   double commission = 0;
//   if (service.equals("dstv")){
//       commission = 0.5;
//   }else if (service.equals("gotv")){
//       commission = 0.5;
//   }else if (service.equals("starttime")){
//       commission = 0.5;
//   }
//   return commission;
// }
...
exports.airvendResource = {
  ...
  CABLETV: { // Variation === true
    ...
    STARTIMES: {
      ...
      Type: "70",
      NetworkID: null,
      Product: false, // todo - false No product
      verify: true,
      percentageCommission: 0,
    },
  },
...
exports.primeAirtimeServices = {
  ...
  DATA: { // Variation = true, verify = false
    AIRTEL_DATA: {
      Service: "AIRTEL_DATA",
      serviceID: "airtel-data",
      sku: "",
  ...
  CABLETV: { // Variation === true
    ...
    STARTIMES: {
      ...
      serviceID: 'Startimes',
      sku: "BPD-NGCA-AWA",
      Product: false, // todo - false NO PRODUCT LIST
      verify: true,
      percentageCommission: 0,
...
exports.vtpassServices = {
  ...
  DATA: {
    ...
    SMILE_BUNDLE: {
      ...
      sku: "smile-direct",
      Product: true,
      verify: true, // todo - verify dont really work on vtpass
      percentageCommission: 0,
    },
  },
  CABLETV: {
