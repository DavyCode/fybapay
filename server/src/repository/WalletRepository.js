...
export default {
  ...
  */
  ...
  async findZeroBalance() {},
  async findZeroBalanceTransfer() {},
  // sumCharges
  // sumDailyTransactionAmount
  // findCommissionsGreaterThanZero
  // countByTypeAndStatusAndPlatform
  // sumByTypeAndStatusAndPlatform
  // sumTotalTransactionAmountByTransactionType
